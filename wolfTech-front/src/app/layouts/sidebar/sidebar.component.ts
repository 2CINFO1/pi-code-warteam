...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/comments', title: 'Comments',  icon:'ni ni-palette text-orange', class: '', role: ['ceo', 'manager'] },
    { path: '/leave-request', title: 'Leave request',  icon: 'ni ni-palette text-orange', class: '', role: ['consultant', 'manager'] },
    { path: '/leave-list', title: 'Leave list',  icon: 'ni ni-palette text-orange', class: '', role: ['consultant', 'manager'] },
